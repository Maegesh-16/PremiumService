...
public static class AuthenticationExtensions
{
    public static IServiceCollection AddPremiumServiceAuthentication(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAuthorization(options =>
        {
            ...
            options.AddPolicy(PremiumServicePolicies.PremiumManage, policy => policy.RequireAuthenticatedUser().RequireRole(PremiumServiceRoles.Agent, PremiumServiceRoles.CustomerSupport, PremiumServiceRoles.Administrator));
        });
